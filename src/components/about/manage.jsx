  ...
  const management = {
    ceos: [
      ...
      },
      {
        ...
        about: "Oyiza Salu is a versatile and results-oriented professional with expertise in human capital and leadership development. She brings significant experience from the financial services industry having previously worked in Stanbic IBTC Bank (a member of the Standard Bank Group) and Guaranty Trust Bank, where she championed several high impact initiatives in her role as Group Head, Human Resources. She is a Member of the Chartered Institute of Personnel Management of Nigeria, a Senior Certified Professional of the Society for Human Resource Management, USA, and an Honorary Senior Member of the Chartered Institute of Bankers of Nigeria. She obtained a Bachelor’s Degree in Chemical Engineering from the Ahmadu Bello University, Zaria, and a Masters in Business Administration from the University of Liverpool, United Kingdom. Oyiza has completed immersive trainings from renowned institutions such as IE Business School, Madrid, Ross School of Business – University of Michigan, and the Lagos Business School (Advanced Management Programme – AMP 32).",
      },
      {
        id: 5,
        img: marketing,
        ...
        about: "Adesegun is a skilled corporate industry professional with sound experience building sustainable businesses and delivering growth, strategy, communications, and marketing solutions for innovative brands. His core interests lie in fostering viable business environments for people and institutions using modern, cost-effective, and adaptable approaches. Over the past couple of years, he has successfully executed high-level brand management and core business development projects for notable brands in Clinical Health, Brand Consulting, Health Insurance, Healthcare Financing and Investments, and Insurtech organizations. He holds a BSc degree in Physiotherapy from the College of Medicine, University of Lagos and completed his mandatory clinical internship and NYSC posting at the Lagos State University Teaching Hospital (LASUTH), Ikeja, and the Abubakar Tafawa Balewa University Teaching Hospital, Bauchi, respectively. He is a Certified Business Analysis Professional (CBAP), a Financial Modeling & Valuation Analyst (FMVA), and a Project Management Professional (PMP). He enjoys sports, calm music, and group adventures.",
      },
      {
        id: 6,
        img: Sustainability,
        ...
        about: "Vivian possesses a strong background in Nursing Science and has actively championed advancements in Healthcare Quality for more 7+ years. Her passion for healthcare quality improvement has been evident all through her career as a Nurse and even now as a Healthcare Quality Improvement Specialist. She has been involved in several quality improvement projects such as the Quality champions program, Hand hygiene campaigns, improving customer service standards, improving wait times and discharge processing times, and many more. She played a key role as Lead of the St. Nicholas Hospital Accreditation Ready Initiative and worked with her team to implement strategies that enabled the hospital progress to full accreditation by the Council for Health Service Accreditation of Southern Africa (COHSASA). Over the years, she has garnered certifications in Healthcare Quality and Patient Safety, Lean Six Sigma, Monitoring and Evaluation, Quality Management System auditing amongst others. She is a Fellow of the International Society for Quality, a Certified Professional of Healthcare Quality, and she holds a Master’s degree in Business Administration. She is hoping to complete her Doctorate in Healthcare Administration and Fellowship with the West African College of Nursing within the next few years.",
      },
      {
        id: 7,
        img: legal,
