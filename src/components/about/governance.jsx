...
const Governance = () => {
  const [sustainText, setSustainText] = useState(false);
  const [qualityText, setQualityText] = useState(false);
  const [whitsleText, setWhitsleText] = useState(false);
  const [patnershipText, setpatnershipText] = useState(false);
    ...
    <>
      ...
      <section className="sustain">
        ...
        <div>
          ...
          <button
            onClick={() => setSustainText(!sustainText)}
            ...
            <div className="full-text">
              <div>
                <p style={{ marginTop: "0" }}>
                  ...
                  Iwosan Investments Limited is a growth-driven and responsible
                  organization that is devoted to optimizing operations in its
                  portfolio facilities through cost minimization, risk
                  mitigation, client experience improvement and satisfaction,
                  satisfactory clinical outcomes, and community development. We
                  are committed to foreseeing and addressing environmental,
                  social, and corporate governance needs or issues that may
                  arise in our operations. Our company contributes to the global
                  fight against climate change by promoting and implementing
                  environmentally sustainable initiatives such as carbon
                  footprint reduction (through energy conservation), use of
                  renewable energy, water and waste recycling. We strongly
                  believe in the need for diversity, equity and inclusion which
                  is evident in our multi-level staffing, customer base,
                  operations, vendor management, as well as our relationship
                  with business partners and the community. We value our staff
                  and their contribution to our organization. We foster an
                  environment that is healthy and safe for all our staff,
                  clients, and visitors. Our leadership and governance strategy
                  ensures accountability with strong internal operational and
                  financial controls. Consistent organizational performance
                  measurement and management help us to stay on track with
                  providing the best service to our clients and partners. We
                  demonstrate transparency and integrity in our data management
                  through open reporting and strongly discourage unethical
                  conduct.
                </p>
                <button
                  onClick={() => setSustainText(!sustainText)}
          ...
          {qualityText && (
            <div className="full-text">
              <div>
                <p style={{ color: "black" }}>
                  {" "}
                  We ensure the provision of safe and consistent clinical care
                  at all our health facilities by implementing strategies that
                  support clinical governance, patient safety, evidence- based
                  best practice in clinical care, risk management, continuous
                  staff training, use of technology, compliance with healthcare
                  quality standards, continuous systems improvement, and patient
                  satisfaction. The Iwosan Board is committed to Putting the
                  Patient First at all times. We are devoted to hearing the
                  patient’s voice and partnering with patients, families, staff,
                  and caregivers at all stages of their health care journey. We
                  are focused on delivering timely and efficient care that
                  provides our patients with the best possible clinical
                  outcomes, all of which are benchmarked with our peers across
                  all continents. We are intentional about hiring the best
                  complement of staff to achieve our organizational goals. Our
                  ...
                  receptive to new ideas to working optimally and more
          ...
          {whitsleText && (
            <div className="full-text">
              <div>
                <p>
                  {" "}
                  We are Iwosan Investment Limited - a consistently
                  patient-first, world-class healthcare services provider. We
                  are committed to a whistleblowing policy in keeping with the
                  core values of Integrity, Equity, Good Faith, and Fairness -
                  intended to encourage employees and others to make good faith
                  reports of suspected fraud, corruption, or other
                  improprieties, or health and safety concerns that may
                  negatively impact both our internal and external stakeholders.
                  Employees of the Company have an obligation to report
                  irregularities when they become aware and have the right to
                  voice complaints about questionable financial reporting,
                  unethical, illegal, or unlawful activities/procedures without
                  fear that such reports or complaint will impact their
                  employment status, rate of pay or responsibilities within the
                  organization. Where an employee has knowledge of information
                  that violates any law, rule, or regulation as described above,
                  the employee is encouraged to contact his/her immediate
                  supervisor or the Human Resources department to provide
                  information directly or on an anonymous basis to afford the
                  organization a reasonable opportunity to review and take
                  corrective measures. Do you have a report to make? Please send
                  an email to{" "}
                  <a
                    style={{
                      color: "inherit",
          ...
          {patnershipText && (
            <div className="full-text">
              <div>
                <p>
                  {" "}
                  When we began this journey, we did not begin with any end in
                  mind. In fact, we reckoned that this journey may never end
                  given the global trends and considering the healthcare roadmap
                  for the years to come. Still, we charted a clear course that
                  would enable us to make a lasting impact in the lives of
                  millions of people from all races. When we started, we set out
                  with a deep sense of conviction to advance the cause of
                  healthcare and transform Nigeria – and Africa at large – into
                  a global healthcare frontier. Through our acquisition and
                  development of brownfield and greenfield healthcare assets, we
                  have created a formidable foundation on which an
                  inter-connected network of world-class healthcare facilities
                  will be built. And we are on course to attaining a 500- bed
                  hospital network system by 2025. Without a doubt, the journey
                  has been both fulfilling and invigorating. We owe our landmark
                  attainments to the unwavering support we receive from all our
                  team members. In keeping with our mission to build viable
                  healthcare facilities and promote health- oriented
                  initiatives, we also seek out strategic partnerships with
                  budding stakeholders in both private and public sectors around
                  the world. Through our portfolio hospitals, Iwosan Lagoon
                  Hospitals, we have championed and supported notable healthcare
                  causes, especially as regards policy and systems development,
                  community outreach, project finance, capacity development,
                  operational efficiency, organizational wellness, stakeholder
                  events, and CSR. Therefore, if you would like us to
                  collaborate with you on a related project, please send an
                  email to partnerships@iwosanhealth.com
                </p>
                <button
                  onClick={() => setpatnershipText(!patnershipText)}
                  className="contact-btn"
